...
#' @export
setClass(Class="signi.polyreg",  # set signi.polyreg class. this is a subclass of polyreg
         contains="polyreg",
...
#' @export
setAs(from="polyreg", to="signi.polyreg",  # set function 'as' which transforms polyreg class object to signi.polyreg class object
      def=function(from){
        new("signi.polyreg",
            X=from@X,
            Y=from@Y,
...
#' @export
setMethod("print","signi.polyreg",  # set print method for signi.polyreg class object
          function(x, ...){
...
#' @export
setMethod("show","signi.polyreg", # set show method for signi.polyreg class object. It will return the same things as print returns.
          function(object){       
            print(object)
          })